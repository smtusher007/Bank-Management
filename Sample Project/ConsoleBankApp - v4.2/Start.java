			...
			switch(choice)
			{
				...
				case 2: 
					...
					switch(option2)
					{
						case 1:
							...
							if(b.insertCustomer(c1)){ System.out.println("Customer Inserted with ID: "+c1.getNid());}
						...
						case 3:
							...
							System.out.print("Enter an Customer NID to Search: ");
							int nid3 = sc.nextInt();
				...
				case 3:
					...
					switch(option3)
					{
						case 1:
							System.out.println("---------------------------------");
							System.out.println("You Choose to Insert An Account for a Customer");
							System.out.println("---------------------------------");
							...
							if(b.searchCustomer(nid1) != null)
							{
								...
								if(accountType == 1)
								{
									...
									{
										System.out.println(sa.getAccountNumber() + " Inserted for "+ nid1 );
									}
									else
									{
								...
								else if(accountType == 2)
								{
									...
									{
										System.out.println(fa.getAccountNumber() + " Inserted for "+ nid1 );
									}
									else
									{
										System.out.println("Account Can Not be inserted.");
				...
				case 4:
					...
					switch(option4)
					{
							...
							if(b.searchCustomer(nid1) != null)
							{
								...
								if(b.searchCustomer(nid1).searchAccount(an1) != null)
								{
									...
									if(b.searchCustomer(nid1).searchAccount(an1).deposit(am))
									{
										...
										frwd.writeInFile("Deposit: $"+am+" in Account Number: "+ an1 + " by NID: "+nid1);
						...
						case 3:
							System.out.println("---------------------------------");
							System.out.println("You Choose to See Transaction History");
							System.out.println("---------------------------------");
